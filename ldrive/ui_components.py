...
class DriveSettingsDialog(QDialog):
    def __init__(self, remotes, parent=None, profile=None):
        ...
        self.setWindowTitle("Drive Settings" if profile else "New Drive")
    ...
    def _init_ui(self):
        ...
        btns = QHBoxLayout()
        btns.addStretch()
        sv = QPushButton("Save Config")
        sv.setObjectName("MountButton")
        sv.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
        cl = QPushButton("Cancel")
        cl.setObjectName("SubButton")
        cl.setCursor(QCursor(Qt.CursorShape.PointingHandCursor))
...
class DriveCardWidget(QFrame):
    ...
    def _init_ui(self):
        ...
        title_val = self.profile.get('volname') or self.profile['remote']
        self.title_label = QLabel(title_val)
        ...
        self.edit_btn.setFixedSize(65, 34)
...
class LDriveMainWindow(QMainWindow):
    ...
    def _init_ui(self):
        ...
        # Header Area
        header = QHBoxLayout()
        self.header_logo = QLabel("L-Drive Pro")
        self.header_logo.setObjectName("MainTitle")
        ...
        self.add_btn.setFixedSize(75, 30)
